...
> [!NOTE]
> ### If you want to skip the step-by-step guide and see to the final integration, if you've completed the prerequsites above, you can jump to [step 3](#Step-3---Setting-up-the-Redirect-Path "step 3").
